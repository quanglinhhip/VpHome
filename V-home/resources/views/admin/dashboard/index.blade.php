...
<body>
                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                                <img alt="image" class="img-circle" src="theme/admin/img/profile_small.jpg" />
                            </span>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="theme/admin/img/a7.jpg">
                                        </a>
                                        <div>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="theme/admin/img/a4.jpg">
                                        </a>
                                        <div>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="theme/admin/img/profile.jpg">
                                        </a>
                                        <div>
    ...
    <!-- Mainly scripts -->
    <script src="theme/adminjs/jquery-3.1.1.min.js"></script>
    <script src="theme/adminjs/bootstrap.min.js"></script>
    <script src="theme/adminjs/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="theme/adminjs/plugins/slimscroll/jquery.slimscroll.min.js"></script>

    <!-- Flot -->
    <script src="theme/adminjs/plugins/flot/jquery.flot.js"></script>
    <script src="theme/adminjs/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="theme/adminjs/plugins/flot/jquery.flot.spline.js"></script>
    <script src="theme/adminjs/plugins/flot/jquery.flot.resize.js"></script>
    <script src="theme/adminjs/plugins/flot/jquery.flot.pie.js"></script>
    <script src="theme/adminjs/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="theme/adminjs/plugins/flot/jquery.flot.time.js"></script>

    <!-- Peity -->
    <script src="theme/adminjs/plugins/peity/jquery.peity.min.js"></script>
    <script src="theme/adminjs/demo/peity-demo.js"></script>

    <!-- Custom and plugin javascript -->
    <script src="theme/adminjs/inspinia.js"></script>
    <script src="theme/adminjs/plugins/pace/pace.min.js"></script>

    <!-- jQuery UI -->
    <script src="theme/adminjs/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- Jvectormap -->
    <script src="theme/adminjs/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="theme/adminjs/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- EayPIE -->
    <script src="theme/adminjs/plugins/easypiechart/jquery.easypiechart.js"></script>

    <!-- Sparkline -->
    <script src="theme/adminjs/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="theme/adminjs/demo/sparkline-demo.js"></script>
