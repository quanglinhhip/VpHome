...
@section('script-libs')
    <!-- Flot -->
    <script src="{{ asset('theme/admin/js/plugins/flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('theme/admin/js/plugins/flot/jquery.flot.tooltip.min.js') }}"></script>
    <script src="{{ asset('theme/admin/js/plugins/flot/jquery.flot.spline.js') }}"></script>
    <script src="{{ asset('theme/admin/js/plugins/flot/jquery.flot.resize.js') }}"></script>
    <script src="{{ asset('theme/admin/js/plugins/flot/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('theme/admin/js/plugins/flot/jquery.flot.symbol.js') }}"></script>
    <script src="{{ asset('theme/admin/js/plugins/flot/jquery.flot.time.js') }}"></script>
    ...
    <script src="{{ asset('theme/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>

    <!-- EayPIE -->
    <script src="{{ asset('theme/admin/js/plugins/easypiechart/jquery.easypiechart.js') }}"></script>

    <!-- Sparkline -->
    <script src="{{ asset('theme/admin/js/plugins/sparkline/jquery.sparkline.min.js') }}"></script>

    <!-- Sparkline demo data  -->
    <script src="{{ asset('theme/admin/js/demo/sparkline-demo.js') }}"></script>
